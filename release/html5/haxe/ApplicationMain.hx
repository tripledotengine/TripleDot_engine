...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("tEngine", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("tEngine", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "16";
		app.meta["company"] = "tEngine";
		app.meta["file"] = "tEngine";
		app.meta["name"] = "t!DOTe tEngine build";
		app.meta["packageName"] = "com.tEngine.group";
		app.meta["version"] = "Alpha 1";
		...
		#elseif air
		app.window.title = "t!DOTe tEngine build";
		#else
